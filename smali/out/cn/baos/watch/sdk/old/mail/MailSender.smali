.class public Lcn/baos/watch/sdk/old/mail/MailSender;
...
.method private createAttachmentMail(Lcn/baos/watch/sdk/old/mail/MailInfo;Ljava/io/File;)Ljavax/mail/Message;
    .registers 6
    ...
    .line 140
    invoke-virtual {p1}, Lcn/baos/watch/sdk/old/mail/MailInfo;->getProperties()Ljava/util/Properties;

    move-result-object v0

    .line 141
    new-instance v1, Lcn/baos/watch/sdk/old/mail/MailSender$1;

    invoke-direct {v1, p0, p1}, Lcn/baos/watch/sdk/old/mail/MailSender$1;-><init>(Lcn/baos/watch/sdk/old/mail/MailSender;Lcn/baos/watch/sdk/old/mail/MailInfo;)V
    ...
    invoke-virtual {p1}, Lcn/baos/watch/sdk/old/mail/MailInfo;->getFromAddress()Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lcn/baos/watch/sdk/old/mail/MailInfo;->getToAddress()Ljava/lang/String;
    ...
    .line 159
    invoke-virtual {p1}, Lcn/baos/watch/sdk/old/mail/MailInfo;->getSubject()Ljava/lang/String;
    ...
    .line 163
    invoke-virtual {p1}, Lcn/baos/watch/sdk/old/mail/MailInfo;->getContent()Ljava/lang/String;
...
.method public static sendHtmlMail(Lcn/baos/watch/sdk/old/mail/MailInfo;)V
    .registers 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljavax/mail/MessagingException;
    ...
    .line 86
    invoke-virtual {p0}, Lcn/baos/watch/sdk/old/mail/MailInfo;->getProperties()Ljava/util/Properties;

    move-result-object v0

    .line 88
    invoke-virtual {p0}, Lcn/baos/watch/sdk/old/mail/MailInfo;->isValidate()Z
    ...
    .line 89
    new-instance v1, Lcn/baos/watch/sdk/old/mail/MyAuthenticator;

    invoke-virtual {p0}, Lcn/baos/watch/sdk/old/mail/MailInfo;->getUserName()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {p0}, Lcn/baos/watch/sdk/old/mail/MailInfo;->getPassword()Ljava/lang/String;

    move-result-object v3

    invoke-direct {v1, v2, v3}, Lcn/baos/watch/sdk/old/mail/MyAuthenticator;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, Lcn/baos/watch/sdk/old/mail/MailInfo;->getFromAddress()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcn/baos/watch/sdk/old/mail/MailInfo;->getToAddress()Ljava/lang/String;
    ...
    .line 104
    invoke-virtual {p0}, Lcn/baos/watch/sdk/old/mail/MailInfo;->getSubject()Ljava/lang/String;
    ...
    .line 112
    invoke-virtual {p0}, Lcn/baos/watch/sdk/old/mail/MailInfo;->getContent()Ljava/lang/String;
...
# virtual methods
.method public sendFileMail(Lcn/baos/watch/sdk/old/mail/MailInfo;Ljava/io/File;)V
    .registers 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljavax/mail/MessagingException;,
    ...
    .line 128
    invoke-direct {p0, p1, p2}, Lcn/baos/watch/sdk/old/mail/MailSender;->createAttachmentMail(Lcn/baos/watch/sdk/old/mail/MailInfo;Ljava/io/File;)Ljavax/mail/Message;
...
.method public sendTextMail(Lcn/baos/watch/sdk/old/mail/MailInfo;)V
    .registers 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljavax/mail/MessagingException;
    ...
    .line 39
    invoke-virtual {p1}, Lcn/baos/watch/sdk/old/mail/MailInfo;->isValidate()Z
    ...
    invoke-virtual {p1}, Lcn/baos/watch/sdk/old/mail/MailInfo;->getUserName()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {p1}, Lcn/baos/watch/sdk/old/mail/MailInfo;->getPassword()Ljava/lang/String;
