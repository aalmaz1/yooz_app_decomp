...
.method private parse(Ljava/io/Reader;)V
    ...
    move-result-object v1
    :try_end_65
    .catch Ljava/lang/StringIndexOutOfBoundsException; {:try_start_12 .. :try_end_65} :catch_7
    ...
    .catch Ljava/lang/StringIndexOutOfBoundsException; {:try_start_65 .. :try_end_68} :catch_7
...
.method public appendToMailcap(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v0}, Lcom/sun/activation/registries/MailcapFile;->parse(Ljava/io/Reader;)V
    :try_end_20
    .catch Ljava/io/IOException; {:try_start_18 .. :try_end_20} :catch_20
...
.method protected parseLine(Ljava/lang/String;)V
    ...
    if-eq v9, v6, :cond_113

    if-eq v9, p1, :cond_113
