...
.method private final copyDatabaseFile(Ljava/io/File;Z)V
    ...
    :try_end_3b
    .catch Ljava/lang/Exception; {:try_start_35 .. :try_end_3b} :catch_ce
...
.method private final createFrameworkOpenHelper(Ljava/io/File;)Landroidx/sqlite/db/SupportSQLiteOpenHelper;
    ...
    move-result v0
    :try_end_4
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_4} :catch_32
...
.method private final verifyDatabaseFile(Z)V
    ...
    move-result v4
    :try_end_36
    .catchall {:try_start_2f .. :try_end_36} :catchall_ac
    ...
    :try_end_42
    .catch Ljava/io/IOException; {:try_start_3c .. :try_end_42} :catch_46
    .catchall {:try_start_3c .. :try_end_42} :catchall_ac
    ...
    throw v0
    :try_end_4f
    .catchall {:try_start_47 .. :try_end_4f} :catchall_ac
    ...
    move-result v4
    :try_end_56
    .catch Ljava/io/IOException; {:try_start_4f .. :try_end_56} :catch_a0
    .catchall {:try_start_4f .. :try_end_56} :catchall_ac
    ...
    move-result v4
    :try_end_6d
    .catchall {:try_start_5e .. :try_end_6d} :catchall_ac
    ...
    move-result v4
    :try_end_79
    .catchall {:try_start_73 .. :try_end_79} :catchall_ac
    ...
    :try_end_9c
    .catchall {:try_start_80 .. :try_end_9c} :catchall_ac
