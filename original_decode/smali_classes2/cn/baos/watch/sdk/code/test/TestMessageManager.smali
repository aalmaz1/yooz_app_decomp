.class public Lcn/baos/watch/sdk/code/test/TestMessageManager;
.super Ljava/lang/Object;
.source "TestMessageManager.java"


# static fields
.field private static instance:Lcn/baos/watch/sdk/code/test/TestMessageManager;
...
.method public constructor <init>()V
    ...
    .line 26
    iput v0, p0, Lcn/baos/watch/sdk/code/test/TestMessageManager;->byteNumBig:I

    const/4 v0, 0x0

    .line 27
    iput v0, p0, Lcn/baos/watch/sdk/code/test/TestMessageManager;->byteNumSmall:I

    return-void
.end method

.method public static getInstance()Lcn/baos/watch/sdk/code/test/TestMessageManager;
    .locals 2

    .line 30
    sget-object v0, Lcn/baos/watch/sdk/code/test/TestMessageManager;->instance:Lcn/baos/watch/sdk/code/test/TestMessageManager;

    if-nez v0, :cond_1

    .line 31
    const-class v0, Lcn/baos/watch/sdk/code/test/TestMessageManager;

    monitor-enter v0

    .line 32
    :try_start_0
    sget-object v1, Lcn/baos/watch/sdk/code/test/TestMessageManager;->instance:Lcn/baos/watch/sdk/code/test/TestMessageManager;

    if-nez v1, :cond_0

    .line 33
    new-instance v1, Lcn/baos/watch/sdk/code/test/TestMessageManager;

    invoke-direct {v1}, Lcn/baos/watch/sdk/code/test/TestMessageManager;-><init>()V

    sput-object v1, Lcn/baos/watch/sdk/code/test/TestMessageManager;->instance:Lcn/baos/watch/sdk/code/test/TestMessageManager;
...
.method private getStringHexForBigPackageNew()Ljava/lang/String;
    ...
    .line 99
    iget v0, p0, Lcn/baos/watch/sdk/code/test/TestMessageManager;->byteNumBig:I
    ...
    .line 103
    invoke-static {v1}, Lcn/baos/watch/sdk/code/test/TestMessageManager;->getRandStr(I)Ljava/lang/String;
...
.method private getStringHexForSmallPackageNew()Ljava/lang/String;
    ...
    .line 108
    iget v0, p0, Lcn/baos/watch/sdk/code/test/TestMessageManager;->byteNumSmall:I
    ...
    .line 112
    invoke-static {v0}, Lcn/baos/watch/sdk/code/test/TestMessageManager;->getRandStr(I)Ljava/lang/String;
...
.method public getCurrentBigPackage()Ljava/lang/String;
    ...
    .line 81
    iget-object v0, p0, Lcn/baos/watch/sdk/code/test/TestMessageManager;->mCurrentBigPackage:Ljava/lang/String;
...
.method public getCurrentSmallPackage()Ljava/lang/String;
    ...
    .line 41
    iget-object v0, p0, Lcn/baos/watch/sdk/code/test/TestMessageManager;->mCurrentSmallPackage:Ljava/lang/String;
...
.method public startBigPackageTest(I)Ljava/lang/String;
    ...
    .line 64
    invoke-direct {p0}, Lcn/baos/watch/sdk/code/test/TestMessageManager;->getStringHexForBigPackageNew()Ljava/lang/String;

    move-result-object p1

    iput-object p1, p0, Lcn/baos/watch/sdk/code/test/TestMessageManager;->mCurrentBigPackage:Ljava/lang/String;
    ...
    .line 77
    iget-object p1, p0, Lcn/baos/watch/sdk/code/test/TestMessageManager;->mCurrentBigPackage:Ljava/lang/String;
...
.method public startSmallPackageTest(I)Ljava/lang/String;
    ...
    .line 48
    invoke-direct {p0}, Lcn/baos/watch/sdk/code/test/TestMessageManager;->getStringHexForSmallPackageNew()Ljava/lang/String;

    move-result-object p1

    iput-object p1, p0, Lcn/baos/watch/sdk/code/test/TestMessageManager;->mCurrentSmallPackage:Ljava/lang/String;
    ...
    .line 57
    iget-object p1, p0, Lcn/baos/watch/sdk/code/test/TestMessageManager;->mCurrentSmallPackage:Ljava/lang/String;
